...
class OrderController extends AbstractController
{
     ...
     * @return Response
     */
    #[Route('/commande/annuler/{reference}', name: 'cancel_order')]
    public function cancel(Order $order, EntityManagerInterface $em, Cart $cart): Response
    {
        // Vérifier que l'utilisateur courant est le propriétaire de la commande
